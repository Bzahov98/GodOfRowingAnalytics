...
object TimeUtils {
    fun getTimeAgo(time: Long, context: Context): String {
        ...
        return when {
            ...
            diff < 60 * MINUTE_IN_MILLIS -> context.getString(R.string.text_time_more_minutes_ago,
                diff / MINUTE_IN_MILLIS)
            diff < 2 * HOUR_IN_MILLIS -> context.getString(R.string.text_time_one_hour_ago)
            diff < 24 * HOUR_IN_MILLIS -> context.getString(R.string.text_time_more_hour_ago,
                diff / HOUR_IN_MILLIS)
